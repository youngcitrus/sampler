...
#--------------------------------------------------------------------------------------------
#Create and save Sweater Weather Samples

sw_sample1 = Sample.create({name: '808 Cute Bass', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample2 = Sample.create({name: 'Cute Baile Beat', pack_id: pack3.id, key: '-', bpm: '129'})
sw_sample3 = Sample.create({name: 'Cute Chords Music Loop', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample4 = Sample.create({name: 'Cute Ujico Lead', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample5 = Sample.create({name: 'Drum Loop Trappy', pack_id: pack3.id, key: '-', bpm: '129'})
sw_sample6 = Sample.create({name: 'Drum Loop Full', pack_id: pack3.id, key: '-', bpm: '124'})
sw_sample7 = Sample.create({name: 'Filtered Saw Melody', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample8 = Sample.create({name: 'Filtered Saw Pad', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample9 = Sample.create({name: 'Full Rhythm Synths', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample10 = Sample.create({name: 'Game Chords Glassy', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample11  = Sample.create({name: 'Groovy Drum Build', pack_id: pack3.id, key: '-', bpm: '129'})
sw_sample12  = Sample.create({name: 'Guitar Arpeggio Amaj7', pack_id: pack3.id, key: 'A', bpm: '129'})
sw_sample13  = Sample.create({name: 'Guitar Arpeggio Emaj7', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample14  = Sample.create({name: 'Jersey Style Breakbeat', pack_id: pack3.id, key: '-', bpm: '124'})
sw_sample15  = Sample.create({name: 'Kalimba Arpeggio Amaj7', pack_id: pack3.id, key: 'A', bpm: '129'})
sw_sample16  = Sample.create({name: 'Kalimba Arpeggio Emaj7', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample17  = Sample.create({name: 'Kawaii Synth Stabs', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample18  = Sample.create({name: 'Kawaii Synth Stabs 2', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample19  = Sample.create({name: 'LFO Chill Chords', pack_id: pack3.id, key: 'C', bpm: '110'})
sw_sample20  = Sample.create({name: 'Percussion Cute Loop', pack_id: pack3.id, key: '-', bpm: '129'})
sw_sample21  = Sample.create({name: 'Romantic Violin Melody', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample22  = Sample.create({name: 'Romantic Violin Melody 2', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample23  = Sample.create({name: 'Shiny Bells Melody', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample24  = Sample.create({name: 'Thick Juicy Bass', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample25  = Sample.create({name: 'Toy Hi-hat Loop', pack_id: pack3.id, key: '-', bpm: '129'})
sw_sample26  = Sample.create({name: 'Tremolo Guitar Strings', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample27  = Sample.create({name: 'Unique Drums Chanty', pack_id: pack3.id, key: 'E', bpm: '129'})
sw_sample28  = Sample.create({name: 'Video Game Keys', pack_id: pack3.id, key: 'C#', bpm: '124'})
sw_sample29  = Sample.create({name: 'Vocal Chops + Percussion', pack_id: pack3.id, key: 'C#', bpm: '124'})

#Open Sweater Weather Sample files from AWS
sw_file1 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-808-slidey-e-major-129.mp3')
sw_file2 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-cute-baile-beat-129.mp3')
sw_file3 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-cute-chords-arp-c%23-major-124.mp3')
sw_file4 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-cute-ujico-lead-c%23-major-124.mp3')
sw_file5 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-drum-loop-cute-trappy-129.mp3')
sw_file6 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-drum-loop-full-124.mp3')
sw_file7 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-filtered-saw-melody-c%23-major-124.mp3')
sw_file8 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-filtered-saw-pad-c%23-major-124.mp3')
sw_file9 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-full-rhythm-synths-c%23-major-124.mp3')
sw_file10 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-game-chords-glassy-e-major-129.mp3')
sw_file11 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-groovy-drum-build-129.mp3')
sw_file12 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-guitar-arpeggio-a-major7-129.mp3')
sw_file13 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-guitar-arpeggio-e-major7-129.mp3')
sw_file14 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-jersey-style-breakbeat-124.mp3')
sw_file15 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-kalimba-arpeggio-a-major7-129.mp3')
sw_file16 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-kalimba-arpeggio-peru-e-major7-129.mp3')
sw_file17 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-kawaii-synth-stabs-c%23-major-124.mp3')
sw_file18 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-kawaii-synth-stabs-e-major-129.mp3')
sw_file19 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-lfo-chords-c-major-110.mp3')
sw_file20 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-perc-loop-cute-129.mp3')
sw_file21 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-romantic-violin-1-e-major-129.mp3')
sw_file22 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-romantic-violin-2-e-major-129.mp3')
sw_file23 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-shiny-bells-c%23-major-124.mp3')
sw_file24 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-thick-bass-c%23-major-124.mp3')
sw_file25 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-toy-hat-loop-129.mp3')
sw_file26 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-tremolo-guitar-e-major-129.mp3')
sw_file27 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-unique-drums-chanty-129.mp3')
sw_file28 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-video-game-keys-c%23-major-124.mp3')
sw_file29 = open('https://sampler-dev.s3-us-west-1.amazonaws.com/seeds/samples/sweater-weather/sw-vocal-chops-perc-loop-e-major-129.mp3')

# Sweater Weather Samples Attach
sw_sample1.file.attach(io: sw_file1, filename:'sw-808-slidey-e-major-129.mp3')
sw_sample2.file.attach(io: sw_file2, filename:'sw-cute-baile-beat-129.mp3')
sw_sample3.file.attach(io: sw_file3, filename:'sw-cute-chords-arp-c#23-major-124.mp3')
sw_sample4.file.attach(io: sw_file4, filename:'sw-cute-ujico-lead-c#23-major-124.mp3')
sw_sample5.file.attach(io: sw_file5, filename:'sw-drum-loop-cute-trappy-129.mp3')
sw_sample6.file.attach(io: sw_file6, filename:'sw-drum-loop-full-124.mp3')
sw_sample7.file.attach(io: sw_file7, filename:'sw-filtered-saw-melody-c#23-major-124.mp3')
sw_sample8.file.attach(io: sw_file8, filename:'sw-filtered-saw-pad-c#23-major-124.mp3')
sw_sample9.file.attach(io: sw_file9, filename:'sw-full-rhythm-synths-c#23-major-124.mp3')
sw_sample10.file.attach(io: sw_file10, filename:'sw-game-chords-glassy-e-major-129.mp3')
sw_sample11.file.attach(io: sw_file11, filename:'sw-groovy-drum-build-129.mp3')
sw_sample12.file.attach(io: sw_file12, filename:'sw-guitar-arpeggio-a-major7-129.mp3')
sw_sample13.file.attach(io: sw_file13, filename:'sw-guitar-arpeggio-e-major7-129.mp3')
sw_sample14.file.attach(io: sw_file14, filename:'sw-jersey-style-breakbeat-124.mp3')
sw_sample15.file.attach(io: sw_file15, filename:'sw-kalimba-arpeggio-a-major7-129.mp3')
sw_sample16.file.attach(io: sw_file16, filename:'sw-kalimba-arpeggio-peru-e-major7-129.mp3')
sw_sample17.file.attach(io: sw_file17, filename:'sw-kawaii-synth-stabs-c#23-major-124.mp3')
sw_sample18.file.attach(io: sw_file18, filename:'sw-kawaii-synth-stabs-e-major-129.mp3')
sw_sample19.file.attach(io: sw_file19, filename:'sw-lfo-chords-c-major-110.mp3')
sw_sample20.file.attach(io: sw_file20, filename:'sw-perc-loop-cute-129.mp3')
sw_sample21.file.attach(io: sw_file21, filename:'sw-romantic-violin-1-e-major-129.mp3')
sw_sample22.file.attach(io: sw_file22, filename:'sw-romantic-violin-2-e-major-129.mp3')
sw_sample23.file.attach(io: sw_file23, filename:'sw-shiny-bells-c#23-major-124.mp3')
sw_sample24.file.attach(io: sw_file24, filename:'sw-thick-bass-c#23-major-124.mp3')
sw_sample25.file.attach(io: sw_file25, filename:'sw-toy-hat-loop-129.mp3')
sw_sample26.file.attach(io: sw_file26, filename:'sw-tremolo-guitar-e-major-129.mp3')
sw_sample27.file.attach(io: sw_file27, filename:'sw-unique-drums-chanty-129.mp3')
sw_sample28.file.attach(io: sw_file28, filename:'sw-video-game-keys-c#23-major-124.mp3')
sw_sample29.file.attach(io: sw_file29, filename:'sw-vocal-chops-perc-loop-e-major-129.mp3')